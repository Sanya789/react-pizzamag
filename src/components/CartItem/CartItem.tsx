...
export const CartItem: React.FC<CartItemProps> = ({ id, title, type, price, size, count, imageUrl }) => {
  ...
  const onClickRemove = () => {
    if (window.confirm('Вы уверены, что хотите удалить пиццу из заказа?')) dispatch(removeItem(id));
  };
